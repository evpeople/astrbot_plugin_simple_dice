...
from astrbot.core.message.message_event_result import MessageChain, Plain, MessageEventResult
...
class MyPlugin(Star):
    ...
    @llm_tool()
    async def roll_dice(self, event: AstrMessageEvent, expression: str = "1d20", hidden: bool = False):
